/****************************************************************************
** Meta object code from reading C++ file 'Time.hh'
**
...
#include "../../Interface/Time.hh"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'Time.hh' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Time_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 11, 6),
QT_MOC_LITERAL(4, 18, 9),
QT_MOC_LITERAL(5, 28, 10)
    },
    "Time\0Lose\0\0decSec\0stopTimer\0startTimer"
};
...
void Time::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Time::Lose)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Time::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_Time.data,
      qt_meta_data_Time,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Time.stringdata))
